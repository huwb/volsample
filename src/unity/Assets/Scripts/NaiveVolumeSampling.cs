...
public class NaiveVolumeSampling : UnityStandardAssets.ImageEffects.PostEffectsBase
{
    ...
    void OnGUI()
    {
        ...
        _taa = GUI.Toggle( new Rect( 5f, 5f, 150f, 25f ), _taa, "TAA" );
